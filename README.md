...
This respository is cloned into your local project foler during the 'tapestry deploy' command. This respository supplies the necessary Grouparoo configuration files to build a basic Grouparoo image. 
